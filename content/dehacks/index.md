...
<style>
    ...
    .input-container-3 {
        position: relative;
        transform: default; /* Center horizontally and vertically */
    }
...
<!-- Question 5 -->
<div class="mc-container mc-container-2 disable-item" id="Q4">
    <div class="form-check">
        <input class="form-check-input bg-secondary" type="radio" name="flexRadioDefault" id="flexRadioDefault1">
...
<!-- Question 8 -->
<div class="mc-container disable-item" id="Q7">
    <div class="form-check">
        <input class="form-check-input bg-secondary" type="radio" name="flexRadioDefault" id="flexRadioDefault1">
...
<!-- Question 9 -->
<!-- Checkboxes -->
<div class="form-check-wrapper mc-container disable-item" id="Q8">
    <div class="form-check">
...
<!-- Question 10 -->
<div class="input-container input-container-3 disable-item" id="Q9">
    <label class="form-label input-label">FHDA CWID: </label>
    <textarea class="input-control-long bg-dark"></textarea>
</div>
<!-- Question 11 -->
<div class="mc-container mc-container-2 disable-item" id="Q10">
    <div class="form-check">
        <input class="form-check-input bg-secondary" type="radio" name="flexRadioDefault" id="flexRadioDefault1">
...
<!-- Question 12 -->
<div class="mc-container mc-container-2 disable-item" id="Q11">
    <div class="form-check">
        <input class="form-check-input bg-secondary" type="radio" name="flexRadioDefault" id="flexRadioDefault1">
...
<!-- Question 13 -->
<div class="input-container input-container-3 disable-item" id="Q12">
    <label class="form-label input-label">FHDA CWID: </label>
    <textarea class="input-control-long bg-dark"></textarea>
</div>
<!-- Question 14 -->
<div class="input-container input-container-3 disable-item" id="Q13">
    <label class="form-label input-label">FHDA CWID: </label>
    <textarea class="input-control-long bg-dark"></textarea>
</div>
...
<script>
    ...
    const questions = [
        ...
        "Are you current an FHDA student?",
        "What year of study are you in?",
        "What is your major?",
        "What is your skill level?",
        "How many hackathons have you been a part of?",
        "Do you have any dietary restrictions?",
        "Do you have any additional accommodational needs?",
        "What is your T-Shirt Size?",
        "Will you have access to a computer during the hackathon?",
        "Why are you attending DAHacks 3.0?",
        "What additional information would you like us to know? Feel free to include any significant coding or hackathon experiences below!"
    ];
    ...
    function displayQuestion() {
        ...
        questionLabel.textContent = questions[currentIndex];

        // Hide all question containers
        const allQuestionContainers = document.querySelectorAll('.input-container, .mc-container, .form-check-wrapper, .input-container-3');
        allQuestionContainers.forEach(container => container.classList.add('disable-item'));

        // Show the current question container
        const currentQuestionId = `Q${currentIndex}`;
        const currentQuestionContainer = document.getElementById(currentQuestionId);
        if (currentQuestionContainer) {
            currentQuestionContainer.classList.remove('disable-item');
        }

        if (currentIndex === 0) {
            const q100Element = document.getElementById('Q100');
            q100Element.classList.remove('disable-item');
        }
